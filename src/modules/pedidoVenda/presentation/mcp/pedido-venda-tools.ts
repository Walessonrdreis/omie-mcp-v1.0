...
export const pedidoVendaTools: ToolDef[] = [
  ...
  defineTool({
    ...
    description:
      ...
      "ListarEtapasFaturamento (recurso 'produtos/etapafat'). É este catálogo que traduz o código " +
      "de etapa dos DOIS kanbans: operação '11' — Venda de Produto (etapa do pedido) e operação " +
      "'28' — Ordem de Produção (cEtapa da OP). Cada conta renomeia as etapas: prefira cDescricao " +
      "e caia para cDescrPadrao só quando ele vier vazio.",
    inputSchema: { param: paramSchema },
